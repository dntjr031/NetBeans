...
public class ProductDAO {
    ...
    public int insert(ProductDTO dtoPro) throws SQLException {
        try {
            ...
            ps.setString(2, dtoPro.getPname());
            ps.setString(3, dtoPro.getItem_code());
            ps.setInt(4, dtoPro.getPrice());
            ps.setInt(5, dtoPro.getStock());
    ...
    public int deleteByPcode(String pcode) throws SQLException {
        try{
            con = DBUtil.getConnection();
            ...
            int n = ps.executeUpdate();
            System.out.println("n="+n+", pcode="+pcode);
